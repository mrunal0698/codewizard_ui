...
const StepsElevenPage = () => {
  return (
    <>
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] p-[164px] sm:px-[20px] md:px-[40px] w-[100%]">
        <div className="flex flex-col items-center justify-start max-w-[919px] mx-[auto] w-[100%]">
          <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-evenly w-[100%]">
            <div className="flex md:flex-1 flex-col md:gap-[40px] gap-[72px] items-center justify-start md:w-[100%] w-[6%]">
              ...
              <div className="h-[121px] md:h-[74px] relative w-[100%]">
                <div className="absolute bottom-[0] h-[74px] right-[42%] w-[11%]">
                ...
                <StepsTwentySixCheckmark className="absolute border-[1px] border-solid border-teal_A400 flex h-[48px] inset-x-[0] items-center justify-center mx-[auto] sm:px-[20px] px-[24px] py-[12px] rounded-[50%] top-[0] w-[48px]" />
              </div>
              <StepsTwentySixCheckmark className="border-[1px] border-solid border-teal_A400 flex h-[48px] items-center justify-center sm:px-[20px] px-[24px] py-[12px] rounded-[50%] w-[48px]" />
            </div>
            <div className="flex md:flex-1 flex-col md:gap-[40px] gap-[72px] items-start justify-start md:w-[100%] w-[95%]">
              <div className="h-[168px] relative w-[100%]">
              ...
              <div className="h-[48px] relative sm:w-[100%] w-[67%]">
                <div className="absolute bottom-[42%] md:h-[5px] h-[6px] left-[0] sm:w-[100%] w-[92%]">
                  ...
                  <Line className="absolute bg-teal_A400 bottom-[0] h-[5px] left-[0] w-[46%]" />
                </div>
                <StepsThirteenStepper
                  className="absolute border-[1px] border-solid border-teal_A400 flex flex-col h-[100%] md:h-[auto] inset-y-[0] items-center justify-start left-[42%] my-[auto] sm:px-[20px] px-[22.8px] py-[9.6px] rounded-[50%] sm:w-[100%] w-[48px]"
                  one="10"
                />
          ...
          <Text
            className="font-semibold mt-[90px] text-center text-gray_50 w-[auto]"
            as="h2"
            variant="h2"
          >
...
export default StepsElevenPage;
