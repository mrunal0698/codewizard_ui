...
const BasicDetailsFourPage = () => {
  const navigate = useNavigate();
  const selected_basicDetails = useSelector(store => store.frontend.frontend_details?.basicDetail);
  ...
  useEffect(()=> {
    const keysToRemove = ["ApplicationDescription","Namespace"];
  ...
  const validateForm = (e) => {
    ...
    setError((obj) => {
        ...
        switch(name){
            ...
            case "Namespace" :
                if(!value){
                    curError[name] = "Please enter Backend API URL"
                  }
                  break ;
            default :
              break;              
  ...
  useEffect(() => {
    console.log(error);
    if(error.dropdown || error.ApplicationName){
          ...
          <div className="flex flex-1 flex-col items-center justify-start w-[100%] pt-[32px]">
            ...
            <div className="flex md:flex-col flex-row gap-[10px] items-center justify-between mt-[8px] w-[100%] relative">
              ...
              <div className="flex sm:flex-1 flex-col gap-[8px] items-start justify-start self-stretch sm:w-[100%] md:w-[100%] w-[48%] relative">
                ...
                <Input
                  ...
                  className="font-normal not-italic p-[0] placeholder:text-gray_801 text-[12px] text-gray_300 text-left w-[100%]"
                  name="Namespace"
                  placeholder="http://3.133.64.67:8196/PetRegistration"
                  onChange = {onchangeHandler}
                  activeInputValue = {activeInputValue}
                  updateInputValue = {updateInputValue}
            ...
            <div className="flex flex-col gap-[8px] items-start justify-start max-w-[982px] mt-[20px] w-[100%]">
              ...
              <textarea
                      id="message"
                      rows="4"
                      className="block p-2.5 w-full text-sm text-gray_300 bg-gray_902 rounded-lg border-[1px] solid border-gray_801 !font-inter !font-light placeholder:text-gray_801 !text-[12px] focus:border-gray_501"
                      placeholder="Enter Description Of Your Application"
                      onChange={onchangeHandler}
                      name="ApplicationDescription"
...
export default BasicDetailsFourPage;
