    ...
    <>
      <div className="bg-gray_900 flex flex-col font-inter items-center justify-start mx-[auto] p-[164px] sm:px-[20px] md:px-[40px] w-[100%]">
        <div className="md:h-[245px] h-[288px] max-w-[919px] mx-[auto] relative w-[100%]">
          <div className="absolute md:h-[245px] h-[267px] inset-x-[0] mx-[auto] top-[0] w-[100%]">
            <div className="absolute bottom-[0] flex inset-x-[0] items-center justify-start mx-[auto] w-[96%]">
            ...
            <div className="absolute bottom-[37%] flex flex-row inset-x-[0] items-center justify-between mx-[auto] w-[37%]">
            ...
            <StepsTwentySixCheckmark className="absolute border-[1px] border-solid border-teal_A400 bottom-[37%] flex h-[48px] items-center justify-center sm:px-[20px] px-[24px] py-[12px] right-[0] rounded-[50%] w-[48px]" />
            <StepsThirteenStepper
              className="absolute border-[1px] border-solid border-teal_A400 bottom-[37%] flex flex-col h-[48px] md:h-[auto] items-center justify-start left-[0] sm:px-[20px] px-[22.8px] py-[9.6px] rounded-[50%] sm:w-[100%] w-[48px]"
              one="8"
            />
          </div>
          ...
          <Line className="absolute bg-teal_A400 bottom-[30%] h-[35px] left-[3%] w-[5px]" />
        </div>
        <Text
