...
const StepsTwentySevenPage = () => {
  return (
    <>
      <div className="bg-gray_900 font-inter h-[833px] mx-[auto] p-[180px] sm:px-[20px] md:px-[40px] relative w-[100%]">
        <div className="absolute flex inset-x-[0] max-w-[871px] mx-[auto] top-[25%] w-[100%]">
          <div className="flex items-center justify-start my-[auto] w-[67%]">
            <div className="flex flex-col md:gap-[40px] gap-[72px] justify-start w-[100%]">
              <div className="h-[48px] mr-[47px] relative sm:w-[100%] w-[92%]">
              ...
              <div className="h-[48px] md:ml-[0] ml-[243px] relative w-[59%]">
                <Line className="absolute bg-gray_501 h-[5px] inset-[0] justify-center m-[auto] w-[73%]" />
          ...
          <div className="md:h-[125px] h-[168px] ml-[-47px] my-[auto] w-[39%] z-[1]">
        ...
        <div className="absolute bottom-[25%] flex flex-col gap-[13px] inset-x-[0] items-center justify-start max-w-[877px] mx-[auto] w-[100%]">
          <Text
        ...
        <StepsTwentySixCheckmark className="absolute border-[1px] border-solid border-teal_A400 flex h-[48px] items-center justify-center left-[22%] sm:px-[20px] px-[24px] py-[12px] rounded-[50%] top-[25%] w-[48px]" />
      </div>
    </>
  );
};

export default StepsTwentySevenPage;
