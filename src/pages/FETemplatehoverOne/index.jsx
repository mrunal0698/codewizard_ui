...
import FETemplateHoverOneSidebarcheckmark from "components/FETemplateHoverOneSidebarcheckmark";
import { Text, Line, Img, Button } from "components";
import FETemplateButton from "components/FETemplateButton";

const FETemplatehoverOnePage = () => {
  return (
    <>
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col flex-row gap-[24px] items-center justify-between w-[100%]">
          <FETemplateHoverOneSidebarcheckmark
            className="bg-gray_901 flex flex-col md:hidden justify-start md:px-[20px] w-[250px]"
            ...
            <div className="md:h-[625px] h-[713px] relative w-[100%]">
              ...
              <div className="absolute flex flex-col items-start justify-start left-[0] top-[3%] w-[38%]">
                <div className="flex flex-row gap-[20px] items-center justify-between w-[100%]">
                  ...
                  <div className="bg-gray_901 md:h-[179px] h-[181px] relative rounded-[4px] w-[181px]">
                    <Img
                      src="images/img_image62_2.png"
                      className="h-[91px] m-[auto] object-cover rounded-[4px] w-[92%]"
                      alt="imageSixtyTwo_Three"
                    />
                    <div className="absolute bg-gray_900_66 flex flex-col gap-[33px] h-[100%] inset-[0] items-center justify-center m-[auto] p-[25px] sm:px-[20px] rounded-[4px] w-[181px]">
                      <div className="flex flex-row gap-[4px] items-start justify-start mt-[49px] self-stretch w-[auto]">
                        <Img
                        ...
                        />
                        <Img
                          src="images/img_clock_gray_50_32x32.svg"
                          className="h-[32px] w-[32px]"
                          alt="clock"
                        />
                      </div>
...
export default FETemplatehoverOnePage;
