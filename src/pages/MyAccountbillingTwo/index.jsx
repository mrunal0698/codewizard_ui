...
import MyAccountBillingTwoButton from "components/MyAccountBillingTwoButton";
import { useNavigate } from "react-router-dom";

const MyAccountbillingTwoPage = () => {
      ...
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] pb-[24px] sm:pr-[20px] pr-[24px] w-[100%]">
        <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between max-w-[1256px] mb-[23px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:mt-[0] mt-[32px] w-[100%]">
            ...
            >
              <div className="bg-gray_901 md:h-[351px] h-[413px] relative rounded-[4px] w-[100%]">
                ...
                <div className="absolute bottom-[0] flex flex-1 inset-x-[0] items-center justify-start mx-[auto] pb-[32px] sm:px-[20px] px-[32px] w-[100%]">
                  <Button className="border-[1px] border-solid border-teal_A400 cursor-pointer font-medium px-[20px] py-[12px] rounded-[4px] text-[14px] text-center text-teal_A400 w-[252px]">
                    Downgrade
                  </Button>
                </div>
              </div>
            ...
            <Text
              className="common-pointer border-b-[1px] border-solid border-teal_A400 font-medium mt-[12px] self-stretch text-left text-teal_A400 w-[auto]"
              variant="body2"
            ...
            <div className="flex flex-col gap-[16px] items-start justify-start mt-[30px] self-stretch md:w-[100%] w-[auto]">
              ...
              <div className="flex flex-col gap-[16px] items-start justify-start self-stretch md:w-[100%] w-[auto]">
                <div className="flex md:flex-col flex-row gap-[12px] items-start justify-start max-w-[912px] w-[100%]">
                  <div className="bg-gray_901 border-[1px] border-gray_801 border-solid flex flex-1 sm:flex-col flex-row gap-[4px] items-start justify-start p-[16px] rounded-[4px] w-[100%]">
                    <div className="flex flex-1 sm:flex-col flex-row gap-[12px] items-start justify-start w-[100%]">
                  ...
                  <div className="bg-gray_901 border-[1px] border-gray_801 border-solid flex flex-1 sm:flex-col flex-row gap-[4px] items-start justify-start p-[16px] rounded-[4px] w-[100%]">
                    <div className="flex flex-1 sm:flex-col flex-row gap-[12px] items-start justify-start w-[100%]">
                      <Img
                        ...
                        className="h-[32px] max-h-[32px] rounded-[6px] w-[auto] sm:w-[auto]"
                        alt="computer"
                      />
                        ...
                        <div className="flex items-start justify-start self-stretch w-[auto]">
                          <div className="flex items-start justify-start self-stretch w-[auto]">
                            <div className="flex items-center justify-center self-stretch w-[auto]">
                              <Text
                                className="border-b-[1px] border-gray_300 border-solid font-medium self-stretch text-gray_300 text-left w-[auto]"
                                variant="body2"
                              >
                                Set as default
                              </Text>
                ...
                <div className="flex items-center justify-start w-[100%]">
                  <MyAccountBillingTwoButton className="flex flex-col items-start justify-start self-stretch sm:w-[100%] w-[auto]" />
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-[16px] items-start justify-start max-w-[912px] mt-[28px] w-[100%]">
              <div className="flex items-start justify-start w-[100%]">
                <div className="flex items-center justify-start w-[100%]">
                  <Text
                    className="font-medium text-gray_50 text-left w-[auto]"
...
export default MyAccountbillingTwoPage;
