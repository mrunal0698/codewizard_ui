...
const StepsThreePage = () => {
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-inter sm:gap-[40px] md:gap-[40px] gap-[91px] items-center justify-start mx-[auto] p-[164px] sm:px-[20px] md:px-[40px] w-[100%]">
        <div className="h-[288px] max-w-[919px] mx-[auto] relative w-[100%]">
          <div className="absolute flex h-[100%] inset-y-[0] items-center justify-start left-[0] my-[auto] w-[69%]">
            <div className="flex flex-col md:gap-[40px] gap-[72px] items-center justify-start w-[100%]">
              ...
              <div className="md:h-[136px] h-[168px] relative w-[100%]">
                <div className="absolute flex h-[max-content] inset-[0] items-center justify-center m-[auto] w-[90%]">
                  <div className="flex sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                    <Line className="bg-gray_501 sm:h-[5px] h-[74px] sm:mt-[0] my-[25px] sm:w-[100%] w-[5px]" />
                ...
                <div className="absolute flex flex-col md:gap-[40px] gap-[72px] h-[100%] inset-[0] items-center justify-center m-[auto] w-[auto]">
                ...
                <StepsThirteenColumntwo className="absolute border-[1px] border-gray_501 border-solid flex font-normal h-[48px] items-center justify-center left-[0] not-italic sm:px-[20px] rounded-[50%] text-[16px] text-center text-gray_501 top-[0] w-[48px]" />
          ...
          <div className="absolute md:h-[125px] h-[168px] right-[0] top-[0] w-[37%]">
        ...
        <div className="flex flex-col gap-[13px] items-center justify-start max-w-[877px] mx-[auto] w-[100%]">
          <Text
