...
import ModelLibraryNotFoundSidemenu from "components/ModelLibraryNotFoundSidemenu";
import { Text, Line, Button, Input, Img } from "components";
import { CloseSVG } from "../../assets/images";

const ModelLibrarynotfoundPage = () => {
      ...
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between max-w-[1256px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:mt-[0] mt-[32px] w-[100%]">
            ...
            <Img
              src="images/img_frame52985.svg"
              className="h-[132px] mt-[178px] w-[132px]"
              alt="frame52985"
            />
            <Text
              className="font-normal mt-[17px] not-italic text-gray_50 text-left w-[auto]"
              as="h6"
              variant="h6"
            >
              No Results Found
            ...
            <Text
              className="font-normal leading-[150.00%] mt-[6px] not-italic text-center text-gray_501 sm:w-[100%] w-[26%]"
              variant="body2"
            >
...
export default ModelLibrarynotfoundPage;
