...
const ModelLibrarysearchactivePage = () => {
      ...
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between max-w-[1256px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-start justify-start md:mt-[0] mt-[32px] w-[100%]">
            ...
            <div className="flex md:flex-col flex-row md:gap-[40px] items-center justify-between mt-[32px] w-[100%]">
              ...
              <div className="flex sm:flex-1 sm:flex-col flex-row gap-[16px] items-start justify-start self-stretch sm:w-[100%] w-[auto]">
                <Input
                  ...
                  wrapClassName="common-pointer bg-gray_902 border-[1px] border-gray_501 border-solid flex p-[16px] rounded-[4px] sm:w-[100%] w-[53%]"
                  ...
                  placeholder="Cus|"
                  suffix={() =>
                    navigate("/modellibrarysearchresult")?.length > 0 ? (
                      <CloseSVG
            ...
            <div className="flex sm:flex-col flex-row gap-[24px] items-center justify-start mt-[24px] md:w-[100%] w-[49%]">
              ...
              <ModelLibraryCategory5
                className="bg-gray_901 flex flex-col h-[227px] items-center justify-center p-[13px] rounded-[8px] sm:w-[100%] w-[227px]"
...
export default ModelLibrarysearchactivePage;
