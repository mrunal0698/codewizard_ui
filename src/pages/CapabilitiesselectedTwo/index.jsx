...
import CapabilitiesTwoSidemenu from "components/CapabilitiesTwoSidemenu";
...
const CapabilitiesselectedTwoPage = () => {
  return (
    <>
...
export default CapabilitiesselectedTwoPage;
