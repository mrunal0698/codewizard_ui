          ...
          <div className="flex flex-1 flex-col gap-[32px] items-center justify-start md:mt-[0] mt-[32px] md:px-[20px] w-[100%]">
            <div className="flex flex-col items-center justify-start w-[100%]">
              ...
              <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between w-[100%]">
                <div className="flex md:flex-1 flex-col gap-[24px] items-start justify-start md:mt-[0] mt-[2px] md:w-[100%] w-[48%]">
                  <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                    <div className="h-[249px] relative w-[100%]">
                      <div className="flex flex-col items-start justify-start mb-[-19px] ml-[auto] mr-[69px] self-stretch shadow-bs1 w-[auto] z-[1]">
                        <div className="bg-gray_801 flex items-start justify-start px-[12px] py-[8px] rounded-[4px] w-[100%]">
                          <Text
                            ...
                            variant="body3"
                          >
                            MySQL isn’t Compatible with Spring
                          </Text>
                        </div>
                        <Img
                      ...
                      <Text
                        className="font-medium mb-[undefinedpx] ml-[auto] mr-[133px] mt-[40px] text-center text-teal_A400 w-[auto] z-[1]"
                        variant="body3"
                      >
...
export default DatabaselockedTwoPage;
