  ...
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-inter gap-[123px] sm:gap-[40px] md:gap-[40px] items-center justify-start mx-[auto] p-[24px] sm:px-[20px] w-[100%]">
        ...
        <div className="flex flex-col gap-[31px] items-center justify-start mb-[154px] md:px-[20px] md:w-[100%] w-[46%]">
          <Text
          ...
          <div className="flex flex-col items-start justify-start w-[100%]">
            ...
            <div className="flex flex-col gap-[8px] items-start justify-start mt-[21px] self-stretch sm:w-[100%] w-[auto]">
              <Text
                className="font-semibold text-gray_300 text-left w-[auto]"
                variant="body2"
              >
...
export default ResetPasswordFourPage;
