...
const ModelLibrarynotfoundOnePage = () => {
      ...
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between max-w-[1256px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:mt-[0] mt-[32px] w-[100%]">
            ...
            <Img
              src="images/img_group52978.svg"
              className="h-[132px] mt-[108px] w-[auto]"
              alt="group52978"
            />
            <Text
              className="font-normal mt-[27px] not-italic text-gray_50 text-left w-[auto]"
              as="h6"
              variant="h6"
            >
              It’s empty in here!
            ...
            <Text
              className="font-normal mt-[9px] not-italic text-center text-gray_501 w-[auto]"
              variant="body2"
            >
              Drop files and folders to begin.
            </Text>
            <Button
              className="bg-teal_A400 cursor-pointer flex items-center justify-center min-w-[217px] mt-[32px] px-[20px] py-[16px] rounded-[4px] w-[auto]"
              leftIcon={
                <Img
                  src="images/img_plus_gray_900.svg"
                  className="mr-[8px]"
...
export default ModelLibrarynotfoundOnePage;
