...
const AllfeaturesandbenefitsPage = () => {
        ...
        <div className="h-[1574px] md:px-[20px] px-[24px] relative md:w-[100%] w-[1280px]">
          ...
          <div className="absolute flex h-[100%] inset-[0] items-center justify-start m-[auto] max-w-[1280px] sm:px-[20px] px-[40px] w-[100%]">
            <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start w-[100%]">
              <div className="h-[1574px] relative md:w-[100%] w-[50%]">
                ...
                <div className="absolute md:h-[40px] h-[47px] right-[34%] top-[32%] w-[150px]">
                  <div className="absolute bottom-[-1%] flex inset-x-[0] items-start justify-end mx-[auto] self-stretch shadow-bs1 w-[auto]">
                    <Img
                  ...
                  <FloatingInput
                    wrapClassName="font-medium placeholder:left-[12px] p-[0] text-[12px] text-center text-gray_50 placeholder:text-teal_A400 placeholder:top-[0] w-[100%]"
                    className="font-medium p-[0] text-[12px] text-center text-gray_50 w-[100%]"
                    name="content"
                    labelClasses="left-[12px] top-[0] text-teal_A400"
                    focusedClasses="translate-y-[17px] scale-[1]"
                    wrapperClasses="w-[100%] top-[0] absolute"
                    labelText="(This will be on hover)"
                    defaultText="Explanation of feature"
                  ></FloatingInput>
                </div>
              </div>
              <div className="flex flex-1 flex-col items-start justify-start w-[100%]">
                <div className="flex flex-col h-[306px] md:h-[auto] items-start justify-start pb-[48px] w-[100%]">
                  ...
                  <div className="flex flex-col gap-[24px] items-start justify-start pt-[32px] sm:px-[20px] px-[24px] w-[100%]">
                    ...
                    <Button
                      className="common-pointer bg-gradient  cursor-pointer font-medium p-[12px] rounded-[4px] text-[14px] text-center text-gray_900 w-[252px]"
                      onClick={() => navigate("/myaccountbilling")}
                    >
                      Upgrade Now
                    </Button>
                  </div>
...
export default AllfeaturesandbenefitsPage;
