...
const AddCardDetailsNineteenPage = () => {
  return (
    <>
      <div className="bg-gray_900 flex font-inter items-center justify-start mx-[auto] pb-[24px] sm:pr-[20px] pr-[24px] w-[100%]">
        <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between max-w-[1256px] mb-[2px] mx-[auto] md:px-[20px] w-[100%]">
          <Sidebar className="flex flex-col md:hidden justify-start w-[320px]" />
          <div className="flex flex-1 flex-col gap-[32px] items-center justify-start md:mt-[0] mt-[32px] w-[100%]">
...
export default AddCardDetailsNineteenPage;
