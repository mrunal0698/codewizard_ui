...
const DatabaseTwoSidemenu = (props) => {
  return (
    <>
      <aside className={props.className}>
        <div className="flex items-center justify-start ml-[34px] mr-[24px] my-[113px] w-[77%]">
          <div className="flex flex-row gap-[9px] items-center justify-between w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start w-[auto]">
              ...
              <Text
                className="font-inter font-normal md:ml-[0] ml-[3px] mt-[63px] not-italic text-gray_50 text-left w-[auto]"
                as="h5"
                variant="h5"
              >
              ...
              <Text
                className="font-inter font-light leading-[150.00%] md:ml-[0] ml-[3px] mt-[59px] text-gray_300 text-left sm:w-[100%] w-[91%]"
                as="h6"
                variant="h6"
              >
              ...
              <Text
                className="font-inter font-light md:ml-[0] ml-[3px] mt-[35px] text-gray_300 text-left w-[auto]"
                as="h6"
                variant="h6"
              >
                {props?.basicdetails}
...
DatabaseTwoSidemenu.defaultProps = {
  one: "5",
  componentNine: "6",
  componentTwelve: "7",
  componentEleven: "8",
...
export default DatabaseTwoSidemenu;
