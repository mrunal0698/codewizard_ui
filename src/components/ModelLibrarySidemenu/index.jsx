...
const ModelLibrarySidemenu = (props) => {
  const navigate = useNavigate();

  return (
    <>
      <aside className={props.className}>
        <div className="flex items-center justify-start ml-[12px] my-[24px] w-[96%]">
          <div className="flex flex-col gap-[32px] justify-start w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start w-[100%]">
              <div className="flex items-start justify-start p-[12px] rounded-[4px] md:w-[100%] w-[95%]">
                <div className="flex flex-row gap-[16px] items-center justify-start self-stretch w-[auto]" onClick={() => navigate("/our-home")}>
                  <Img
              ...
              <div className="flex items-start justify-start mt-[8px] p-[12px] rounded-[4px] md:w-[100%] w-[95%]">
                <div className="flex flex-row gap-[16px] items-center justify-start self-stretch w-[auto]" onClick={() => navigate("/settings")}>
                  <Img
...
ModelLibrarySidemenu.defaultProps = {
  label: "Home",
...
export default ModelLibrarySidemenu;
