...
const CapabilitiesSidemenu = (props) => {
  return (
    <>
        ...
        <div className="flex items-center justify-start mx-[auto] my-[194px] w-[73%]">
          <div className="flex flex-row gap-[9px] items-center justify-between w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start w-[auto]">
              ...
              <Text
                className="font-inter font-normal leading-[150.00%] md:ml-[0] ml-[3px] mt-[54px] not-italic text-gray_50 text-left sm:w-[100%] w-[98%]"
                as="h5"
                variant="h5"
              >
              ...
              <Text
                className="font-inter font-light md:ml-[0] ml-[3px] mt-[41px] text-gray_300 text-left w-[auto]"
                as="h6"
                variant="h6"
              >
                {props?.basicdetails}
...
CapabilitiesSidemenu.defaultProps = {
  one: "4",
  componentEleven: "5",
  componentTwelve: "6",
...
export default CapabilitiesSidemenu;
